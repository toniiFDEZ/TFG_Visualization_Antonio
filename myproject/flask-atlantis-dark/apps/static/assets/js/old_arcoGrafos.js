...
// function _order(d3, html) {
  ...
  //       console.log(`Node A: ${a.label}, Lift: ${aLift}`);
  //       console.log(`Node B: ${b.label}, Lift: ${bLift}`);
  ...
  //   { 
  //     name: "Color Random", 
  //     value: () => d3.selectAll("path").style("stroke", function() {
...
// function _margin() {
//   return (
//     { top: 20, right: 20, bottom: 20, left: 380 }
//   )
// }
